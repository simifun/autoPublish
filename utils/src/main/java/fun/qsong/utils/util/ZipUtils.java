...
public final class ZipUtils {
     ...
     * @throws Exception
     */
    public static String zipStr(String data_str) throws Exception {
     ...
     * @throws Exception
     */
    public static String zipStr(byte[] data) throws Exception {
        ByteArrayInputStream bais = new ByteArrayInputStream(data);
        ByteArrayOutputStream baos = new ByteArrayOutputStream();
    ...
    private static void compress(InputStream is, OutputStream os)
        ...
        while ((count = is.read(data, 0, KB)) != -1) {
     ...
     * @throws Exception
     */
    public static byte[] unzipStr(byte[] data) throws Exception {
        ByteArrayInputStream bais = new ByteArrayInputStream(data);
        ByteArrayOutputStream baos = new ByteArrayOutputStream();
     ...
     * @throws Exception
     */
    public static byte[] unzipStr(String str) throws Exception {
    ...
    private static void decompress(InputStream is, OutputStream os){
        ...
        try {
            ...
            int count;
            byte data[] = new byte[KB];
            while ((count = gis.read(data, 0, KB)) != -1) {
