...
public final class AppUtils {
    ...
    public static void installApp(Context context, File file) {
        ...
        context.startActivity(IntentUtils.getApkFileIntent(file));
    }
    ...
    public static void installApp(Activity activity, File file, int requestCode) {
        if (!FileUtils.isFileExists(file)) return;
        activity.startActivityForResult(IntentUtils.getApkFileIntent(file), requestCode);
    }
    ...
    /**
     * 获取App的root权限，设备必须已破解(获得ROOT权限)
     *
     * @param packageCodePath 通过getPackageCodePath()得到该值
     * @return {@code true}: 是<br>{@code false}: 否
     */
    public static boolean getAppRoot(String packageCodePath) {
